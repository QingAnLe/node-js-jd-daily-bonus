...
function getAuthorShareCode() {
  return new Promise(resolve => {
    $.get({url: "https://TESTgitee.com/shylocks/updateTeam/raw/main/jd_bean_home",headers:{
...
function getAuthorShareCode2() {
  return new Promise(resolve => {
    $.get({url: "https://TESTgitee.com/lxk0301/updateTeam/raw/master/shareCodes/jd_updateBeanHome.json",headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }}, async (err, resp, data) => {
      try {
        if (err) {
